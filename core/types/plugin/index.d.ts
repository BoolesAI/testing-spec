...
export { loadConfig, findConfigFile, findLocalConfigFile, findGlobalConfigFile, loadJsonConfig, mergeConfigs, ensureGlobalConfigDir, getPluginOptions, resolvePluginPath, CONFIG_FILE_NAME, GLOBAL_CONFIG_DIR, GLOBAL_CONFIG_PATH, PLUGINS_DIR, type TSpecConfig, type LoadedConfig } from './config.js';
